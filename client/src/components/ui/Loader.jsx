      ...
      {isVisible && (
        ...
        >
          <motion.div
            ...
            className="font-display text-4xl sm:text-5xl font-bold text-slate-900 dark:text-ink tracking-tight mb-8"
          >
          ...
          <motion.span
            ...
            className="font-mono text-xs text-slate-900 dark:text-ink-muted mt-4 tracking-widest"
          >
            {progress}%
          </motion.span>
        </motion.div>
