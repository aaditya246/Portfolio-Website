    ...
    >
      ...
      <div className="pb-10 flex-1">
        <GlassCard className="p-5 sm:p-6">
          ...
          <h3 className="font-display text-lg sm:text-xl font-semibold text-slate-900 dark:text-ink mt-2">
            {item.role}
          </h3>
          <p className="text-slate-900 dark:text-ink-muted text-sm sm:text-base mt-1">{item.organization}</p>
        </GlassCard>
      </div>
    </motion.div>
  )
