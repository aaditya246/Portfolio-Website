    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-6 order-2 lg:order-1">
          ...
          <motion.h1
            variants={heroItem}
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-slate-900 dark:text-ink tracking-tight leading-[1.1]"
          >
            {personalInfo.name}
          ...
          <motion.div
            variants={heroItem}
            className="text-xl sm:text-2xl md:text-3xl font-display font-semibold text-slate-900 dark:text-ink-faint h-10"
          >
          ...
          <motion.p
            variants={heroItem}
            className="text-slate-900 dark:text-ink-muted text-base sm:text-lg leading-relaxed max-w-xl"
          >
        ...
        {/* Right: Terminal signature element + image */}
        <motion.div
          variants={heroItem}
        ...
        >
          ...
          <div className="w-full glass-card overflow-hidden">
            ...
            <div className="flex items-center gap-2 px-4 py-3 border-b border-border bg-panel-light/50">
              ...
              <span className="ml-3 font-mono text-xs text-slate-900 dark:text-ink-muted">profile.js</span>
            </div>

            {/* Terminal body */}
            <div className="p-5 font-mono text-sm leading-relaxed">
              <p className="text-slate-900 dark:text-ink-muted">
                <span className="text-accent">const</span>{' '}
                <span className="text-slate-900 dark:text-ink">developer</span> = {'{'}
              </p>
              <p className="pl-4 text-slate-900 dark:text-ink-muted">
              ...
              <p className="text-slate-900 dark:text-ink-muted">{'};'}</p>
            </div>
          </div>
        </motion.div>
      </motion.div>
      ...
      >
        <span className="font-mono text-xs text-slate-900 dark:text-ink-muted tracking-widest uppercase">
          Scroll
        </span>
        <motion.div
          animate={{ y: [0, 8, 0] }}
