        ...
        <motion.div variants={staggerItem}>
            <GlassCard className="h-full flex flex-col gap-5 relative overflow-hidden">
                ...
                <div className="flex flex-col gap-1 pr-24">
                    ...
                    <p className="text-ink-muted text-sm sm:text-base">{project.subtitle}</p>
                    {project.event && (
                ...
                <div className="flex flex-wrap gap-2 mt-auto pt-2">
                    {project.techStack.map((tech) => (
                        <span
                            key={tech}
                            className="font-mono text-xs px-3 py-1.5 rounded-lg border border-border bg-panel-light/50 text-ink-faint"
                        >
                            {tech}
                        </span>
                    ))}
