              ...
              const content = (
                <GlassCard hoverEffect={!!href} className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="font-mono text-xs text-slate-900 dark:text-ink-muted uppercase tracking-wider">
                      {label}
                    </span>
                    <span className="text-slate-900 dark:text-ink text-sm sm:text-base font-medium break-all">
                      {value}
                    </span>
                  </div>
                </GlassCard>
