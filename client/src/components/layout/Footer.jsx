          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map(({ label, icon: Icon, href }) => (
                  ...
                  aria-label={label}
                  className="w-10 h-10 flex items-center justify-center rounded-lg border border-border bg-panel/60 text-ink-muted transition-colors duration-300 hover:border-border-hover hover:text-accent"
                >
                  <Icon />
                </a>
              ))}
